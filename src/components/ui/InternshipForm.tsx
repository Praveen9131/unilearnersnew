...
export const InternshipForm = ({ internshipTitle, internshipStipend, onClose }: InternshipFormProps) => {
    ...
    try {
      const response = await fetch('https://api.web3forms.com/submit', {
        ...
        body: JSON.stringify({
          ...
          subject: `Internship Application: ${internshipTitle}`,
          ...
          internship_stipend: `₹${internshipStipend.toLocaleString('en-IN')}/month`,
    ...
    <form onSubmit={handleSubmit}>
      ...
      <div style={{ 
        ...
        <div style={{ fontSize: '1.25rem', fontWeight: 700, color: '#0e7c86' }}>
          ₹{internshipStipend.toLocaleString('en-IN')}/month
        </div>
      </div>
